    ...
    subCategories: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Pistachio Croissant", price: "35", tags: ["Cheesy", "Flaky"] },
          { name: "Kunafe Croissant", price: "40", tags: ["Flaky", "Nutty", "Sweet", "Crunchy"] },
          ...
          { name: "Butter Croissant", price: "22.5", tags: ["Buttery", "Flaky", "The O.G"] },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Rusty Brownchiz", price: "50", tags: ["Stretchy", "Cheesy", "Fudgy"] },
    ...
    subCategories: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Ratatouille", price: "32", description: "Arabica, Cream Cheese, Berry, Cookies" },
          { name: "Pistachio Latte", price: "32", description: "Arabica, Pistachio, Pandan, Cookies" },
          { name: "Butterscotch Latte", price: "32", description: "Arabica, Butterscotch, Cookies" },
          { name: "Cola de Mono", price: "33", description: "Arabica, Cinnamon, Palm Sugar, Vanilla" },
        ],
      },
      {
        title: "Tea Selection",
      ...
      },
      {
        ...
        items: [
          { name: "Cendol", price: "35", description: "Pandan, Ice Cream, Traditional Cendol" },
          { name: "Amarena Cherry", price: "35", description: "Cherry, Secret Milk, Ice Cream" },
          { name: "Chocomalt", price: "35", description: "Premium Chocolate, Secret Milk, Ice Cream" },
          { name: "Delimington", price: "38.5", description: "Espresso, Chocolate, Almond Milk, Ice Cream" },
          { name: "Ube & Cheese", price: "35", description: "Homemade Ube, Cream Cheese, Ice Cream" },
          { name: "Strawberry Shortcake", price: "35", description: "Strawberry, Lychee, Skimmed Milk, Ice Cream" },
        ],
      },
      {
        title: "Mocktail Series",
        items: [
          { name: "Butter Beer", price: "32", description: "Butterscotch, Homemade Cola, Vanilla" },
          { name: "Osmanthus Guava", price: "28", description: "Osmanthus, Red Apple Cider, Guava" },
          { name: "P & P", price: "28", description: "Pandan, Jasmine Tea, Pineapple, Coconut Seltzer" },
          { name: "Peach & Passion", price: "30", description: "Peach, Passionfruit, Lemonade, Rosemary" },
        ],
      },
      {
        title: "Coldbrew Series",
        items: [
          { name: "Caffeinated", price: "30", description: "Coldbrew, Sweet Herb, Jasmine, Chocolate" },
          { name: "Melbourne", price: "25", description: "Coldbrew, Orange Peels" },
          { name: "Mango Sticky Rice", price: "32", description: "Coldbrew, Mango, Coconut Flakes, Vanilla" },
          { name: "Dream Cotton", price: "32", description: "Coldbrew, Caramel, Peach, Pineapple" },
          { name: "Blossom", price: "30", description: "Coldbrew, Rose, Palm, Apple" },
        ],
      },
      {
        title: "Tea Series",
        items: [
          { name: "Apple Chai", price: "25", description: "Red Apple Cider, Staranise, Black Tea" },
          { name: "Lychee Tea", price: "25", description: "Jasmine, Lychee, Black Tea" },
          { name: "Lazy Lemon", price: "25", description: "Jasmine Green Tea, Lemonade, Passionfruit" },
          { name: "Milk Tea", price: "28", description: "Osmanthus, Premium Black Tea, Secret Milk" },
        ],
      },
      {
    ...
    subCategories: [
      {
        ...
        items: [
          { name: "Grilled Cheese", price: "45", description: "2 Types of Cheese, Served with Tomato Soup" },
          { name: "English Breakfast", price: "55", description: "Sourdough, Tomato, Spinach, Baked Beans, Mushroom, Beef Ham, Sausages, Eggs Your Way" },
        ],
      },
      {
        title: "Light Bites",
        items: [
          { name: "Parmesan Truffle French Fries", price: "50", description: "French Fries, Truffle Oil, Parmesan" },
          { name: "Chicken Popcorn", price: "35", description: "Chicken Thigh, Cherry Tomato, TPC Seasoning" },
          { name: "Corn Ribs", price: "30", description: "Fried Corn Ribs, Cocktail Mayo, Hot Sauce, Parmesan" },
        ],
      },
      {
        title: "The Perfect Brunch",
        items: [
          { name: "Salmon Truffle Scramble", price: "55", description: "Sourdough, Smoked Salmon, Truffle Oil, Scrambled Egg" },
          { name: "Avocado Toast", price: "55", description: "Sourdough, Guacamole, Ham, Mushroom, Poached Egg" },
          { name: "Smoothie Bowl", price: "40", description: "Dragon Fruit Yogurt, Berries, Banana, Kiwi, Granola" },
        ],
      },
      {
        title: "Sandwiches Club",
        items: [
          { name: "Katsu Sando", price: "45", description: "Brioche, Chicken Breast, Katsu Sauce, Coleslaw" },
          { name: "Philly Cheese Steak", price: "55", description: "Ciabatta, Sliced Beef, Cajun Spice, Cheese Sauce" },
          { name: "Club Sandwich", price: "50", description: "Brioche, Katsu Chicken, Egg, Veggies" },
        ],
      },
      {
        title: "Italian Noodles",
        items: [
          { name: "Creamy Basil Pesto Pasta", price: "45", description: "Spaghetti, Basil Pesto, Parmesan" },
          { name: "Creamy Gochujang Pasta", price: "45", description: "Spaghetti, Prawn, Gochujang, Parmesan" },
          { name: "Prawn Aglio Olio", price: "45", description: "Spaghetti, Prawn, Chilli, Parmesan" },
          { name: "Katsu Carbonara", price: "55", description: "Spaghetti, Chicken Katsu, Creamy Onion, Parmesan" },
        ],
      },
      {
        title: "The Hunger Solution",
        items: [
          { name: "Kimchi Reuben Sandwich", price: "55", description: "Sourdough, Beef Shortplate, Kimchi Mayo, Mozzarella" },
          { name: "Chicken Parmigiana", price: "55", description: "Breaded Chicken, Mashed Potato, Mozzarella, Parmesan" },
          { name: "Chickencado", price: "50", description: "Ciabatta, Basil Pesto, Chicken, Avocado, Mozzarella" },
        ],
      },
      {
        title: "Main Courses",
        items: [
          { name: "Balinese Fried Rice", price: "42.5", description: "Basegenap Fried Rice, Serai Limo Chicken, Sunny Side Up" },
          { name: "Ayam Betutu", price: "47.5", description: "Betutu Fried Chicken, Urap, Rice, Sambal" },
      ...
      },
      {
        ...
        items: [
          { name: "Milo Dino Toast", price: "35", description: "French Toast with Milo Bath" },
          { name: "Cream Cheese Brulee Toast", price: "38", description: "French Toast with Cream Cheese Brulee Bath" },
          { name: "Tiramisu Toast", price: "40", description: "French Toast with Tiramisu Bath" },
          { name: "Matcha Toast", price: "40", description: "French Toast with Matcha Bath" },
        ],
      },
      {
        title: "The Sweets",
        items: [
          { name: "French Toast", price: "55", description: "Brioche, Granola, Berries, Banana, Soft Served Ice Cream" },
        ],
      },
    ],
  },
